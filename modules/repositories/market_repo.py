...
class MarketRepository:
    """
    Repository layer for trade market collections. Encapsulates all DB access for
    live and archived market data.
    """
    def __init__(self):
        # Live market data
        self._coll: MongoCollection = get_collection(ColEnum.MARKET)
        # Archived history
    ...
    def get_all_items_ranking(self) -> List[Dict[str, Any]]:
        """
        ...
        cursor = self._archive.aggregate(pipeline)
        return [
